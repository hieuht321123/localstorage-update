...
export class EditProductComponent implements OnInit {
  ...
  this.activateRouterService.params.subscribe((data: Params) =>{
    ...
    let countryID= this.user.countryId;
    let stateIDs= this.user.statesId;
    let cityID= this.user.citesId;
    this.country = this.coutryService.getCountryById(countryID);
    this.state = this.coutryService.getStatesById(stateIDs);
    this.city = this.coutryService.getCityById(cityID);
  })
